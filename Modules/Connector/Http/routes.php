...
Route::get('profit-loss-report', 'CommonResourceController@getProfitLoss');
	Route::get('expense-report', 'CommonResourceController@getexpense');
	
	Route::get('stock-report', 'CommonResourceController@getStockReport');

	Route::get('register-report', 'CommonResourceController@getRegisterReport');

	Route::get('customer-supplier', 'CommonResourceController@getCustomerSuppliers');

	Route::get('product-sell-report', 'CommonResourceController@getproductSellReport');

	Route::get('trending-products', 'CommonResourceController@getTrendingProducts');
