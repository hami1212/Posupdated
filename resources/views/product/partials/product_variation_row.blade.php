        ...
        <table class="table table-condensed table-bordered blue-header variation_value_table">
            ...
            <tr>
                ...
                <td class="{{$class}}">
                    ...
                    <span class="input-group-btn">
                        <button type="button" class="btn btn-default bg-white btn-flat apply-all btn-sm p-5-5" data-toggle="tooltip" title="@lang('lang_v1.apply_all')" data-target-class=".variable_dsp"><i class="fas fa-check-double"></i></button>
                    </span>
