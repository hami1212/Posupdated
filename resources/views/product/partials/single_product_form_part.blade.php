        ...
        <tr>
          ...
          <td>
        	...
        	@if (!empty($business_details->enable_is_other_currency))
				...
				{{-- dollar price --}}
            <label><span class="">Dollar Price</span></label>
            {!! Form::text('single_dollar_dsp', $default, ['class' => 'form-control input-sm dsp input_number', 'placeholder' => 'Dollar Price']); !!}

            {!! Form::text('single__dollar_dsp_inc_tax', $default, ['class' => 'form-control input-sm hide input_number', 'placeholder' => __('product.inc_of_tax')]); !!}
{{-- //poundprice --}}
             <label><span class="">AUD Price</span></label>
            {!! Form::text('single_aud_dsp', $default, ['class' => 'form-control input-sm dsp input_number', 'placeholder' => 'AUD Price']); !!}

            {!! Form::text('single__aud_dsp_inc_tax', $default, ['class' => 'form-control input-sm hide input_number', 'placeholder' => __('product.inc_of_tax')]); !!}
