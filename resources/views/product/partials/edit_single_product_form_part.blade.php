...
@if (!empty($business_details->enable_is_other_currency))
                        ...
                        {!! Form::text('single_dollar_dsp', @num_format($variation->default_single_dollar_dsp), ['class' => 'form-control input-sm dsp input_number', 'placeholder' => 'Dollar Price']); !!}

            {{-- //poundprice --}}
                        <label><span class="">AUD Price</span></label>
                        {!! Form::text('single_aud_dsp', @num_format($variation->default_single_aud_dsp), ['class' => 'form-control input-sm dsp input_number', 'placeholder' => 'AUD Price']); !!}
@endif
                    </td>
                    <td>
                        @php 
