...
<!--{{-- @dd($receipt_details->business_id); --}}-->



@if ($receipt_details->business_id == 83)


    <table style="width:100%;">
        <tbody>
            <tr>
                <td class="text-center" style="line-height: 15px !important; padding-bottom: 20px !important">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                            @if (!empty($receipt_details->invoice_heading))
                                <p style=" margin-top: 3% !important; font-weight: bold; font-size: 35px !important">
                                    Estimate
                                </p>
                            @endif
                        </div>
            ...
            <tr>
                <td>
                    <div class="row">
                        <div class="col-xs-4">
                            @if (!empty($receipt_details->logo))
                                <img style="max-height: 120px; width: auto;  margin-top: 2px !important;"
                                    src="{{ $receipt_details->logo }}" class="img img-responsive center-block">
                            @endif
                        </div>
                        <div class="col-xs-4">
                            <h4 style="border: 1px solid black; overflow: hidden; margin-top: 2px !important;">Bill To
                            </h4>
                            <div style="border: 1px solid black; overflow: hidden; padding: 25px;">
                                <h4 class="">{{ $receipt_details->customer_name }}</h4>
                            </div>
                        </div>
                        <div class="col-xs-4">
                            <table style="margin-top: 25px !important; margin: 0 auto; text-align: center;"
                                class="width-100 table-f-12 mb-10">
                                <thead class="border-bottom-dotted">
                                    <tr>
                                        <th style="border: 1px solid black; text-align: center;">
                                            <p>{!! $receipt_details->date_label !!}</p>
                                        </th>
                                        <th style="border: 1px solid black; text-align: center;">
                                            <p>{!! $receipt_details->invoice_no_prefix !!}</p>
                                        </th>
                                    </tr>
                                </thead>
                                ...
                                <tbody>
                                    <tr>
                                        <td style="border: 1px solid black;">
                                            <p>{{ $receipt_details->invoice_date }}</p>
                                        </td>
                                        <td style="border: 1px solid black;">

                                            <p>{{ $receipt_details->invoice_no }}</p>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <div class="row margin-right: 10%;">
                        <div class="col-xs-4">
                            <table style="margin: 0 auto; text-align: center;" class="width-100 table-f-12">
                                <thead class="border-bottom-dotted">
                                    <tr>
                                        <th style="border: 1px solid black; text-align: center;">
                                            <p>Delivered By</p>
                                ...
                                <tbody>
                                    <tr>
                                        <td style="border: 1px solid black;">
                                            <p> {{ $receipt_details->shipping_details }}</p>
                                        </td>
                                        {{-- <td style="border: 1px solid black;">
                                        <p>{{ $receipt_details->invoice_no }}</p>
                                    </td> --}}
                    ...
                    <div class="row ">
                        <div class="col-xs-12">
                            <br />
                            <table class="table table-bordered table-no-top-cell-border table-slim mb-7">
                                <thead>
                        ...
                        <div class="col-md-6 invoice-col width-50">
                            <table class="table-no-side-cell-border table-no-top-cell-border width-100 table-slim">
                                <tbody>
                                    ...
                                    @endif
                                    <tr style="border: 1px solid black; text-align: center;">
                                        <td style="width:50%" style="border: 1px solid black; text-align: center;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-8">
                            <table style=" margin: 0 auto; text-align: center;" class="width-100 table-f-12 mb-10">
                                <thead class="border-bottom-dotted">
                                    <tr>
                                        <!--<th style="border: 1px solid black; text-align: center;">-->
                                        <!--    <p>Due Date</p>-->
        ...
        <div class="col-xs-8">
            <table style=" margin: 0 auto; text-align: center;" class="width-100 table-f-12 mb-10">
                ...
                <tbody>
                    <tr>
                        <td style="border: 1px solid black;">
                            <p>{{ $receipt_details->mobile }}</p>
                        </td>

                        <td style="border: 1px solid black;">
                            <p>{!! $receipt_details->email !!}</p>
                        </td>
                    </tr>
                </tbody>
            </table>
                    ...
                    <div class="row ">
                        ...
                        @if ($receipt_details->show_barcode || $receipt_details->show_qr_code)
                            <div
                                class="@if (!empty($receipt_details->footer_text)) col-xs-4 @else col-xs-12 @endif text-center">
                                {{-- Barcode --}}
                        ...
                        @endif
                         ...
                         <h3 style="text-align: center">No Return Without a Bill Will Be Accepted 
            </h3>
                  <h4 style="text-align: center;">Thanks For Shopping Here</h4>
                    </div>
