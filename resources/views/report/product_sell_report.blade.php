            ...
            <div class="col-md-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <!--saad-->
                        <li>
                            <a href="#day-by" data-toggle="tab" aria-expanded="true"><i class="fa fa-bars"
                                    aria-hidden="true"></i> By Day </a>
                        </li>
                        <!--saad-->
                    </ul>
...
<div class="tab-pane" id="day-by">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped" id="day_by_group" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <!--<th>ID</th>-->
                                            <th>@lang('messages.date')</th>
                                    ...
                                    <tfoot>
                                        <tr class="bg-gray font-17 footer-total text-center">
                                            ...
                                            <td id="sell_qty"></td>
                                            <td><span class="display_currency" id="row_subtotal"
                                                    data-currency_symbol="true"></span></td>
                                        </tr>
                                    </tfoot>
                                </table>
