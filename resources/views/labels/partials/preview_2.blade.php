{{-- @dd(($pos_settings['print_roll'])) --}}
@if (!empty($pos_settings['print_roll']))

    {{-- @dd('if') --}}
<!--<div class="w100" style="width: 800px;">-->
    <table
        style="margin-left:100; margin-bottom:6px; margin-top:28px text-align:center;	 border-spacing: {{ $barcode_details->col_distance * 1 }}in {{ $barcode_details->row_distance * 1 }}in; overflow: hidden !important;">
        @foreach ($page_products as $page_product)
            {{-- @dd($page_product) --}}
            @if ($loop->index % $barcode_details->stickers_in_one_row == 1)
                <!-- create a new row -->
                <tr>
                    {{-- @dd( $print ) --}}
            ...
            <td align="center" >
                ...
                <div
                    style=" overflow:  !important;display: flex; flex-wrap: wrap;align-content: center;width: {{ $barcode_details->width * 1 }}in; height: {{ $barcode_details->height * 1 }}in; justify-content: center;">
                    ...
                    <div>
                        ...
                        @endif
                        {{-- @dd($barcode_details->is_continuous) --}}
                        ...
                        {{-- Barcode --}}
                        <img style="width:100% !important;height: {{ $barcode_details->height * 0.24 }}in !important; display: block;"
            ...
            @if ($loop->iteration % $barcode_details->stickers_in_one_row == 1)
                </tr>
            @endif
            {{-- @dd($loop->iteration % $barcode_details->stickers_in_one_row == 0) --}}
        @endforeach
        <!--<br>-->
    </table>
<!--</div>-->
