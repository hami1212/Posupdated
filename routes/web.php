...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    //currency change 
    Route::resource('currencychanges', 'CurrencyChangeController');
    ...
    Route::get('/sells/pos/get_product_row/{variation_id}/{location_id}/{selectedValue?}', 'SellPosController@getProductRow');
    ...
    Route::get('/pos-location', 'SellPosController@getlocationId');
    ...
    //Reports...
     Route::get('/reports/oder_reports', 'ReportController@oder_reports');
    Route::get('/reports/user_login', 'ReportController@user_login');
    ...
    //saad
    Route::get('/reports/product-sell-grouped-by-day', 'ReportController@productSellReportByday');
    //saad
