...
class ProductUtil extends Util
{
    ...
    public function createSingleProductVariation($product, $sku, $purchase_price, $dpp_inc_tax, $profit_percent, $selling_price, $selling_price_inc_tax,
     $single_dollar_dsp=null,$single_aud_dsp=null,$combo_variations = [])
    {
        ...
        $variation_data = [
                ...
                'default_single_dollar_dsp' => $this->num_uf($single_dollar_dsp),
                'default_single_aud_dsp' => $this->num_uf($single_aud_dsp),
     ...
     * @return array
     */
    public function getDetailsFromVariation($variation_id, $business_id, $location_id = null, $check_qty = true, $selectedValue = null)
    {
