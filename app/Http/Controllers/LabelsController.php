        ...
        //    $len=$len-1;
            ...
            foreach ($product_details_page_wise as $page => $page_products) {
                ...
                $output = view('labels.partials.preview_2')
                            ->with(compact('print', 'page_products', 'business_id', 'pos_settings','business_name', 'barcode_details', 'margin_top', 'margin_left', 'paper_width', 'paper_height', 'is_first', 'is_last', 'factor'))->render();
                print_r($output);
                // dd($output);
