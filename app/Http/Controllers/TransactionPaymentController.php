...
class TransactionPaymentController extends Controller
{
            ...
            if ($due_payment_type == 'purchase') {
                ...
                $payment_line->amount = $contact_details->total_purchase_return -
                  ...
                  if ($business_id == 79) {
                    ...
                    $payment_line->amount = $contact_details->total_paid - $contact_details->total_paid + $contact_details->difference  + $contact_details->tr;
 ...
 public function postPayContactDues(Request  $request)
    {
        if (!(auth()->user()->can('sell.payments') || auth()->user()->can('purchase.payments'))) {
            abort(403, 'Unauthorized action.');
        }
        ...
        try {
            ...
            $this->transactionUtil->payContacts($request);
