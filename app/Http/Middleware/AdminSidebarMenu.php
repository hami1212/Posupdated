            ...
            if (auth()->user()->can('product.view') || auth()->user()->can('product.create') ||
                ...
                $menu->dropdown(
                    ...
                    function ($sub) {
                        ...
                        if (auth()->user()->can('brand.view') || auth()->user()->can('brand.create')) {
                            $sub->url(
                                action('CurrencyChangeController@index'),
                                'CurrencyChange',
                ...
                $menu->dropdown(
                    ...
                    function ($sub) use ($enabled_modules, $is_admin) {
                        ...
                        if (auth()->user()->can('tax_report.view')) {
                         ...
                         $sub->url(
                                action('ReportController@oder_reports'),
                        ...
                        if (auth()->user()->id == 110) {
                            $sub->url(
                                action('ReportController@user_login'),
                                __('lang_v1.user_login'),
                                ['icon' => 'fa fas fa-arrow-circle-down', 'active' => request()->segment(2) == 'user_login-report']
                            );
                        }
                    },
