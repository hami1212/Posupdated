...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_in_time":"2000-06-13 13:13:00","clock_in_note":"ea","ip_address":"tempore","latitude":"omnis","longitude":"deleniti"}'
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_out_time":"2000-06-13 13:13:00","clock_out_note":"sint","latitude":"veritatis","longitude":"vel"}'
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/crm/follow-ups?start_date=2020-12-16&end_date=2020-12-16&status=consequatur&follow_up_type=asperiores&order_by=start_datetime&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"title":"Meeting with client","contact_id":2,"description":"et","schedule_type":"at","user_id":"[2,3,5]","notify_before":5,"notify_type":"minute","status":"open","notify_via":"['sms' => 0 ,'mail' => 1]","followup_additional_info":"['call duration' => '1 hour']","start_datetime":"2021-01-06 13:05:00","end_datetime":"2021-01-06 13:05:00","allow_notification":true}'
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/crm/leads?assigned_to=1%2C2%2C3&name=maiores&biz_name=omnis&mobile_num=2&contact_id=voluptatem&order_by=qui&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"call_logs":[{"mobile_number":"aut","mobile_name":"repellat","call_type":"call","start_time":"dolores","end_time":"maiores","duration":"molestiae"}]}'
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":1,"initial_amount":24404,"created_at":"2020-5-7 15:20:22","closed_at":"2020-5-7 15:20:22","status":"close","closing_amount":4513552.336935750208795070648193359375,"total_card_slips":20,"total_cheques":20,"closing_note":"dignissimos","transaction_ids":"1,2,3"}'
...
let body = {
    "location_id": 1,
    "initial_amount": 24404,
    "created_at": "2020-5-7 15:20:22",
    "closed_at": "2020-5-7 15:20:22",
    "status": "close",
    "closing_amount": 4513552.336935750208795070648193359375,
    "total_card_slips": 20,
    "total_cheques": 20,
    "closing_note": "dignissimos",
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/contactapi?type=enim&name=explicabo&biz_name=quam&mobile_num=4&contact_id=dolorem&order_by=ad&direction=rerum&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"quibusdam","prefix":"quia","first_name":"accusamus","middle_name":"et","last_name":"corrupti","tax_number":"8787fefef","pay_term_number":3,"pay_term_type":"months","mobile":"4578691009","landline":"5487-8454-4145","alternate_number":"841847541222","address_line_1":"qui","address_line_2":"nulla","city":"fugiat","state":"ad","country":"consequatur","zip_code":"aperiam","customer_group_id":"quia","contact_id":"dolorem","dob":"2000-06-13","custom_field1":"debitis","custom_field2":"commodi","custom_field3":"quo","custom_field4":"voluptatum","email":"voluptatem","shipping_address":"sit","position":"ut","opening_balance":0,"source_id":10,"life_stage_id":14,"assigned_to":[]}'
...
let body = {
    "type": "customer",
    "supplier_business_name": "quibusdam",
    "prefix": "quia",
    ...
    "contact_id": "dolorem",
    "dob": "2000-06-13",
    "custom_field1": "debitis",
    "custom_field2": "commodi",
    "custom_field3": "quo",
    "custom_field4": "voluptatum",
    "email": "voluptatem",
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"ut","prefix":"occaecati","first_name":"sequi","middle_name":"voluptatem","last_name":"quo","tax_number":"488744dwd","pay_term_number":3,"pay_term_type":"months","mobile":"8795461009","landline":"65484-848-848","alternate_number":"9898795220","address_line_1":"ea","address_line_2":"rem","city":"ab","state":"possimus","country":"molestiae","zip_code":"rerum","customer_group_id":"et","contact_id":"ea","dob":"2000-06-13","custom_field1":"architecto","custom_field2":"quia","custom_field3":"sapiente","custom_field4":"ratione","email":"voluptas","shipping_address":"beatae","position":"nam","opening_balance":10.300000000000000710542735760100185871124267578125,"source_id":11,"life_stage_id":19,"assigned_to":[]}'
...
let body = {
    ...
    "contact_id": "ea",
    "dob": "2000-06-13",
    "custom_field1": "architecto",
    "custom_field2": "quia",
    "custom_field3": "sapiente",
    "custom_field4": "ratione",
    "email": "voluptas",
    "shipping_address": "beatae",
    "position": "nam",
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":17,"amount":453.1299999999999954525264911353588104248046875,"method":"cash","paid_on":"2020-07-22 15:48:29","account_id":1,"card_number":"omnis","card_holder_name":"modi","card_transaction_number":"adipisci","card_type":"reiciendis","card_month":"tempore","card_year":"rerum","card_security":"sed","transaction_no_1":"et","transaction_no_2":"aut","transaction_no_3":"est","cheque_number":"est","bank_account_number":"ea","note":"corrupti"}'
...
let body = {
    ...
    "account_id": 1,
    "card_number": "omnis",
    "card_holder_name": "modi",
    "card_transaction_number": "adipisci",
    "card_type": "reiciendis",
    "card_month": "tempore",
    "card_year": "rerum",
    "card_security": "sed",
    "transaction_no_1": "et",
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/expense?location_id=1&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=pariatur&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":1,"final_total":2772.82588570000007166527211666107177734375,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":6,"expense_for":20,"contact_id":6,"expense_category_id":16,"expense_sub_category_id":6,"additional_notes":"aut","is_refund":0,"is_recurring":0,"recur_interval":3,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"cumque","recur_repetitions":2,"payment":[{"amount":453.1299999999999954525264911353588104248046875,"method":"cash","account_id":15,"card_number":"eos","card_holder_name":"sed","card_transaction_number":"accusamus","card_type":"molestias","card_month":"consequatur","card_year":"nemo","card_security":"saepe","transaction_no_1":"qui","transaction_no_2":"molestias","transaction_no_3":"consequuntur","note":"in","cheque_number":"accusamus"}]}'
...
let body = {
    "location_id": 1,
    "final_total": 2772.82588570000007166527211666107177734375,
    ...
    "payment": [
        {
            ...
            "card_transaction_number": "accusamus",
            "card_type": "molestias",
            "card_month": "consequatur",
            "card_year": "nemo",
            "card_security": "saepe",
            "transaction_no_1": "qui",
            "transaction_no_2": "molestias",
            "transaction_no_3": "consequuntur",
            "note": "in",
            "cheque_number": "accusamus"
        }
    ]
}
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"final_total":7590074.58000000007450580596923828125,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":1,"expense_for":2,"contact_id":7,"expense_category_id":17,"expense_sub_category_id":19,"additional_notes":"voluptatem","is_recurring":0,"recur_interval":1,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"aut","recur_repetitions":12,"payment":[]}'
...
let body = {
    "final_total": 7590074.58000000007450580596923828125,
    "transaction_date": "2020-5-7 15:20:22",
    "tax_rate_id": 1,
    "expense_for": 2,
    "contact_id": 7,
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/expense-refund?location_id=1&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=aliquam&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/field-force?contact_id=et&assigned_to=itaque&status=qui&start_date=2018-06-25&end_date=2018-06-25&per_page=15&order_by_date=desc" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":15,"visit_to":"consequatur","visit_address":"illum","assigned_to":2,"visit_on":"2021-12-28 17:23:00","visit_for":"ea"}'
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"status":"finished","reason_to_not_meet_contact":"velit","visited_on":"2021-12-28 17:23:00","visited_address":"Radhanath Mullick Ln, Tiretta Bazaar, Bow Bazaar, Kolkata, West Bengal, 700 073, India","latitude":"41.40338","longitude":"2.17403","comments":"cupiditate","photo":"eaque"}'
...
let body = {
    "status": "finished",
    "reason_to_not_meet_contact": "velit",
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/product?order_by=illum&order_direction=quo&brand_id=cupiditate&category_id=impedit&sub_category_id=quia&location_id=1&selling_price_group=voluptatem&send_lot_detail=nesciunt&name=blanditiis&sku=modi&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
let params = {
    ...
    "location_id": "1",
    "selling_price_group": "voluptatem",
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/product/1?selling_price_group=incidunt&send_lot_detail=fuga" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
let params = {
    "selling_price_group": "incidunt",
    "send_lot_detail": "fuga",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/variation/2?product_id=voluptas&location_id=1&brand_id=molestiae&category_id=illo&sub_category_id=iste&not_for_selling=nam&name=omnis&sku=exercitationem&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/sell?location_id=1&contact_id=repellendus&payment_status=due%2Cpartial&start_date=2018-06-25&end_date=2018-06-25&user_id=cum&service_staff_id=et&shipping_status=ordered&source=tempore&only_subscriptions=dolores&send_purchase_details=eius&order_by_date=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"sells":[{"location_id":1,"contact_id":5,"transaction_date":"2020-07-22 15:48:29","invoice_no":"velit","source":"api, phone, woocommerce","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":9,"discount_amount":10,"discount_type":"fixed","sale_note":"doloremque","staff_note":"rem","commission_agent":19,"shipping_details":"Express Delivery","shipping_address":"qui","shipping_status":"ordered","delivered_to":"'Mr robin'","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":1,"pay_term_number":3,"pay_term_type":"months","is_suspend":false,"is_recurring":0,"recur_interval":9,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"accusantium","recur_repetitions":1,"rp_redeemed":1,"rp_redeemed_amount":13.5,"types_of_service_id":17,"service_custom_field_1":"nam","service_custom_field_2":"magnam","service_custom_field_3":"est","service_custom_field_4":"voluptates","service_custom_field_5":"aut","service_custom_field_6":"saepe","round_off_amount":2.859999999999999875655021241982467472553253173828125,"table_id":14,"service_staff_id":5,"change_return":0,"products":[{"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":0,"discount_amount":0,"discount_type":"percentage","sub_unit_id":1,"note":"dolores"}],"payments":[{"amount":453.1299999999999954525264911353588104248046875,"method":"cash","account_id":18,"card_number":"fuga","card_holder_name":"omnis","card_transaction_number":"ducimus","card_type":"facilis","card_month":"necessitatibus","card_year":"vel","card_security":"cumque","transaction_no_1":"hic","transaction_no_2":"ut","transaction_no_3":"aut","bank_account_number":"saepe","note":"quibusdam","cheque_number":"tenetur"}]}]}'
    ...
    "sells": [
        {
            ...
            "service_custom_field_1": "nam",
            "service_custom_field_2": "magnam",
            "service_custom_field_3": "est",
            "service_custom_field_4": "voluptates",
            "service_custom_field_5": "aut",
            "service_custom_field_6": "saepe",
            "round_off_amount": 2.859999999999999875655021241982467472553253173828125,
            "table_id": 14,
            "service_staff_id": 5,
            "change_return": 0,
            "products": [
            ...
            "payments": [
                {
                    ...
                    "card_year": "vel",
                    "card_security": "cumque",
                    "transaction_no_1": "hic",
                    "transaction_no_2": "ut",
                    "transaction_no_3": "aut",
                    "bank_account_number": "saepe",
                    "note": "quibusdam",
                    "cheque_number": "tenetur"
                }
            ]
        }
    ]
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/sell/55?send_purchase_details=recusandae" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
let params = {
    "send_purchase_details": "recusandae",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":7,"transaction_date":"2020-5-7 15:20:22","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":3,"discount_amount":10,"discount_type":"fixed","sale_note":"animi","source":"adipisci","staff_note":"incidunt","is_suspend":false,"commission_agent":11,"shipping_details":"Express Delivery","shipping_address":"vel","shipping_status":"ordered","delivered_to":"Mr Robin","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":9,"pay_term_number":4,"pay_term_type":"months","is_recurring":0,"recur_interval":20,"recur_interval_type":"days","subscription_repeat_on":7,"subscription_no":"officiis","recur_repetitions":16,"rp_redeemed":11,"rp_redeemed_amount":13.5,"types_of_service_id":8,"service_custom_field_1":"id","service_custom_field_2":"corrupti","service_custom_field_3":"iusto","service_custom_field_4":"earum","service_custom_field_5":"id","service_custom_field_6":"nesciunt","round_off_amount":417554779.47039997577667236328125,"table_id":4,"service_staff_id":9,"change_return":0,"change_return_id":5,"products":[{"sell_line_id":20,"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":6,"discount_amount":0,"discount_type":"percentage","sub_unit_id":16,"note":"consectetur"}],"payments":[{"payment_id":7,"amount":453.1299999999999954525264911353588104248046875,"method":"cash","account_id":10,"card_number":"accusantium","card_holder_name":"quis","card_transaction_number":"facilis","card_type":"sint","card_month":"nisi","card_year":"qui","card_security":"dignissimos","transaction_no_1":"modi","transaction_no_2":"totam","transaction_no_3":"architecto","note":"ad","cheque_number":"ea","bank_account_number":"et"}]}'
...
let body = {
    ...
    "service_custom_field_1": "id",
    "service_custom_field_2": "corrupti",
    "service_custom_field_3": "iusto",
    "service_custom_field_4": "earum",
    "service_custom_field_5": "id",
    "service_custom_field_6": "nesciunt",
    "round_off_amount": 417554779.47039997577667236328125,
    "table_id": 4,
    "service_staff_id": 9,
    "change_return": 0,
    "change_return_id": 5,
    ...
    "payments": [
        {
            ...
            "method": "cash",
            "account_id": 10,
            "card_number": "accusantium",
            "card_holder_name": "quis",
            "card_transaction_number": "facilis",
            "card_type": "sint",
            "card_month": "nisi",
            "card_year": "qui",
            "card_security": "dignissimos",
            "transaction_no_1": "modi",
            "transaction_no_2": "totam",
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"transaction_id":12,"transaction_date":"2020-5-7 15:20:22","invoice_no":"dolorem","discount_amount":10,"discount_type":"fixed","products":[{"sell_line_id":11,"quantity":1,"unit_price_inc_tax":437.5}]}'
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"id":17,"shipping_status":"ordered","delivered_to":"in"}'
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/taxonomy?type=accusantium" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"surname":"alias","first_name":"harum","last_name":"cum","email":"dolores","is_active":"facere","user_type":"unde","crm_contact_id":9,"allow_login":true,"username":"eius","password":"occaecati","role":16,"access_all_locations":false,"location_permissions":[],"cmmsn_percent":"sit","max_sales_discount_percent":"quos","selected_contacts":false,"selected_contact_ids":[],"dob":"qui","gender":"et","marital_status":"non","blood_group":"odit","contact_number":"quidem","alt_number":"hic","family_number":"accusantium","fb_link":"id","twitter_link":"est","social_media_1":"ut","social_media_2":"et","custom_field_1":"assumenda","custom_field_2":"eum","custom_field_3":"ipsam","custom_field_4":"earum","guardian_name":"amet","id_proof_name":"et","id_proof_number":"voluptatem","permanent_address":"dolore","current_address":"enim","bank_details":[{"account_holder_name":"similique","account_number":"quasi","bank_name":"cumque","bank_code":"dolorem","branch":"quas","tax_payer_id":"accusamus"}]}'
...
let body = {
    ...
    "cmmsn_percent": "sit",
    "max_sales_discount_percent": "quos",
    ...
    "marital_status": "non",
    "blood_group": "odit",
    "contact_number": "quidem",
    "alt_number": "hic",
    "family_number": "accusantium",
    "fb_link": "id",
    "twitter_link": "est",
    "social_media_1": "ut",
    "social_media_2": "et",
    "custom_field_1": "assumenda",
    "custom_field_2": "eum",
    "custom_field_3": "ipsam",
    "custom_field_4": "earum",
    "guardian_name": "amet",
    "id_proof_name": "et",
    "id_proof_number": "voluptatem",
    "permanent_address": "dolore",
    "current_address": "enim",
    "bank_details": [
        {
            "account_holder_name": "similique",
            "account_number": "quasi",
            "bank_name": "cumque",
            "bank_code": "dolorem",
            "branch": "quas",
            "tax_payer_id": "accusamus"
        }
    ]
}
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/user?service_staff=sunt" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"current_password":"dolores","new_password":"possimus"}'
